...
<div class="patient-payment-section mt-3"
    ...
    <div class="patient-payment-row">
        <div class="patient-payment-field patient-payment-amount-col">
            ...
            <div class="patient-payment-meta payment-gst-summary small text-muted<?= $showPaymentDetails ? '' : ' d-none' ?>"
                 id="paymentGstSummary" aria-live="polite"></div>
            <?php show_field_error($errors, 'payment_amount'); ?>
        </div>
        <div class="patient-payment-field patient-payment-method-col payment-detail-col<?= $showPaymentDetails ? '' : ' d-none' ?>">
            ...
            <div class="patient-payment-meta patient-payment-meta--spacer" aria-hidden="true"></div>
            <?php show_field_error($errors, 'payment_method'); ?>
        </div>
        <div class="patient-payment-field patient-payment-status-col payment-detail-col<?= $showPaymentDetails ? '' : ' d-none' ?>">
        ...
        <div class="patient-payment-field patient-payment-partial-col payment-partial-field<?= $showPartialPaid ? '' : ' d-none' ?>"
